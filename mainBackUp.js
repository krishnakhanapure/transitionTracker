   ...
   form.parse(req, function (err, fields, files) {
        ...
        MongoClient.connect("mongodb://localhost:27017/interviewTracker", function(err, db) {
          if(!err) {
            ...
            }else if(req.url == '/fetchVendorMapPage') {
              var aumStr = [];
            ...
            else if(req.url == '/candidatesOfferReleased') {
            ...
            else if(req.url == '/interviewStats') {
            ...
            else if(req.url == '/addVendorDetails') {
            ...
            } else if(req.url == '/mapVendorCanDetails') {
            ...
            else if(req.url == '/getOpenPositions') {
            ...
            else if(req.url == '/getOfferScreen') {
            ...
            else if(req.url == '/displaydashboard') {
